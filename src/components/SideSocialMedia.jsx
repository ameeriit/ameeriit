...
const SideSocialMedia = () => {
  const socialLinks = [
    {
      socials: <FaLinkedin style={{ width: "24px", height: "24px" }} />,
      url: "https://www.linkedin.com/in/amrit-pokharel-359216a8/",
    },
    {
      socials: <FaGithub style={{ width: "24px", height: "24px" }} />,
      url: "https://github.com/ameeriit",
    },
    {
      socials: <FaMailchimp style={{ width: "24px", height: "24px" }} />,
  ...
  return (
    <>
      <style>
        {`
          .social-media-handles span {
            transition: color 0.3s ease;
          }
        `}
      </style>
      <div className="social-media-handles fixed top-[50%] left-4 translate-y-[-50%]  flex flex-col gap-4">
        {socialLinks.map((icon, index) => (
          <li key={index} className="list-none hover:text-malachite">
