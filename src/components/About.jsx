          ...
          <div data-aos="fade-up">
            <div className="text-[12px] md:text-[14px] leading-6 mb-[20px]">
              ...
              <p className="mb-[10px]">
                ...
                Experienced in designing and developing stunning websites and
                user interfaces, committed to delivering high-quality work, and
                staying up-to-date with the latest technologies.
              </p>
              <p className="mb-[10px">
                When I&apos;m not on the computer, I enjoy traveling, gaming,
                and cooking foods.
              </p>
            </div>
